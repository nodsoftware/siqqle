...
public class SqlDataTypeTests
{
    ...
    public void Decimal_ReturnsDecimalDataTypeOfSpecifiedPrecisionAndScale(
        int? precision,
        int? scale
    )
    {
    ...
    public void Equals_WithSqlDataType_ReturnsCorrectly(
        SqlDataType dataType,
        SqlDataType other,
        bool expected
    )
    ...
    public static IEnumerable<object[]> EqualsData(bool exactTypeOnly)
    {
        ...
        {
            SqlDataType.Float(),
            new SqlPrecisionDataType("DOUBLE"),
            false,
        };
    ...
    public static IEnumerable<object[]> GetHashCodeData()
    {
        ...
        yield return new object[]
        {
            new SqlDataType("FOOBAR"),
            new SqlSizedDataType("FOOBAR", 5),
            false,
        };
        yield return new object[]
        {
            new SqlDataType("FOOBAR"),
            new SqlScaledDataType("FOOBAR", 5, 3),
            false,
        };
        yield return new object[]
        {
            new SqlDataType("FOOBAR"),
            new SqlPrecisionDataType("FOOBAR", 5),
            false,
        };

        yield return new object[]
        {
            new SqlSizedDataType("FOOBAR"),
            new SqlSizedDataType("FOOBAR"),
            true,
        };
        yield return new object[]
        ...
        {
            new SqlSizedDataType("FOOBAR", 5),
            new SqlSizedDataType("BARFOO", 5),
            false,
        };
        yield return new object[]
        {
            new SqlSizedDataType("FOOBAR", 5),
            new SqlSizedDataType("FOOBAR", 6),
            false,
        };
        yield return new object[]
        {
        ...
        yield return new object[]
        {
            new SqlScaledDataType("FOOBAR"),
            new SqlScaledDataType("FOOBAR"),
            true,
        };
        yield return new object[]
        {
            new SqlScaledDataType("FOOBAR", 5),
            new SqlScaledDataType("FOOBAR", 5),
            true,
        };
        yield return new object[]
        ...
        {
            new SqlScaledDataType("FOOBAR", 5, 3),
            new SqlScaledDataType("BARFOO", 5, 3),
            false,
        };
        yield return new object[]
        {
            new SqlScaledDataType("FOOBAR"),
            new SqlDataType("BARFOO"),
            false,
        };
        yield return new object[]
        {
        ...
        {
            new SqlScaledDataType("FOOBAR", 5),
            new SqlScaledDataType("BARFOO", 5),
            false,
        };
        yield return new object[]
        {
            new SqlScaledDataType("FOOBAR", 5),
            new SqlScaledDataType("BARFOO", 6),
            false,
        };
        yield return new object[]
        {
        ...
        {
            new SqlScaledDataType("FOOBAR", 5, 3),
            new SqlScaledDataType("FOOBAR", 6, 3),
            false,
        };
        yield return new object[]
        {
            new SqlScaledDataType("FOOBAR", 5, 3),
            new SqlScaledDataType("FOOBAR", 5, 4),
            false,
        };

        yield return new object[]
        {
            new SqlPrecisionDataType("FOOBAR"),
            new SqlPrecisionDataType("FOOBAR"),
            true,
        };
        yield return new object[]
        ...
        {
            new SqlPrecisionDataType("FOOBAR", 5),
            new SqlPrecisionDataType("BARFOO", 5),
            false,
        };
        yield return new object[]
        {
            new SqlPrecisionDataType("FOOBAR", 5),
            new SqlPrecisionDataType("FOOBAR", 6),
            false,
        };
        yield return new object[]
        {
