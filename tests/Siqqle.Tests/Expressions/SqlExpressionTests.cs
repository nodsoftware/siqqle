...
public class SqlExpressionTests
{
    ...
    {
        var expression = SqlExpression.And(
            SqlExpression.GreaterThan("Id", 5),
            SqlExpression.Equal("Name", "Wouter")
        );
        ...
        Assert.Equal(
            ...
            ((SqlBinaryExpression)expression.Left).Operator
        );
    ...
    {
        var expression = SqlExpression.Or(
            SqlExpression.GreaterThan("Id", 5),
            SqlExpression.Equal("Name", "Wouter")
        );
