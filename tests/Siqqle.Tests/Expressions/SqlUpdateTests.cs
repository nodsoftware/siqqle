...
public class SqlUpdateTests
{
    ...
    {
        var update = Sql.Update("Users").Set("Name", "John Doe").Go();
    ...
    {
        var update = Sql.Update("Users").Set("Name", null).Go();

        Assert.NotNull(update.Set);
        Assert.Single(update.Set);
    ...
    {
        var update = Sql.Update("Users").Set("Name", "Joan Doe").Go();
    ...
    public void Where_WithExpression_SetsWhereProperty()
    {
        ...
        Assert.Equal(
            "Id",
            (
                (SqlColumn)((SqlBinaryExpression)update.Where.Predicate).Left
            ).ColumnName.Segments.First()
        );

        Assert.Equal(
            SqlBinaryOperator.Equal,
            ((SqlBinaryExpression)update.Where.Predicate).Operator
        );
