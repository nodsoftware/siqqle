...
public class SqlWriter : IDisposable
{
    ...
    public SqlWriter(StringBuilder builder, SqlDialect dialect, SqlWriterSettings settings)
    {
        ...
        if (settings == null)
            settings = new SqlWriterSettings();
    ...
    /// </summary>
    protected SqlWriterSettings Settings { get; }
    ...
    public void WriteKeyword(SqlKeyword keyword)
    {
        EnsureNotDisposed();
        Write(
            Settings.WriteKeywordsInLowerCase
        ...
        switch (sortOrder)
        {
            ...
            default:
                ...
                throw new ArgumentException(
                    $"The value of argument '{nameof(sortOrder)}' ({(int)sortOrder}) is invalid for Enum type '{nameof(SqlSortOrder)}'."
                );
#endif
        }
    }
    ...
    public void WriteValue(object value)
    {
        ...
        switch (Type.GetTypeCode(value.GetType()))
        {
            ...
            case TypeCode.Boolean:
                Write(Convert.ToString((bool)value ? 1 : 0, CultureInfo.InvariantCulture));
                break;
