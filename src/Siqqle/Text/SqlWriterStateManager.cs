        ...
        private static readonly Dictionary<SqlWriterState, SqlWriterState[]> _transitions = new Dictionary<SqlWriterState, SqlWriterState[]>
            {
                ...
                { SqlWriterState.StartExpression,     new[] { SqlWriterState.Expression, SqlWriterState.StartValues} },
                { SqlWriterState.Expression,          new[] { SqlWriterState.On, SqlWriterState.Where, SqlWriterState.StartExpression, SqlWriterState.StartOrderBy, SqlWriterState.StartList } },
