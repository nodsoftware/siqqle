...
public class SqlUnion : SqlStatement
{
    ...
    public SqlUnion(IEnumerable<SqlSelect> statements)
    {
        ...
        if (!statements.Any())
            throw new ArgumentException(
                "At least one SELECT statement should be provided.",
                nameof(statements)
            );
    ...
    /// </summary>
    public IEnumerable<SqlSelect> Statements { get; }

    /// <summary>
    /// Returns the expression type of this expression.
    /// </summary>
    public override SqlExpressionType ExpressionType => SqlExpressionType.Union;
}
