...
public class SqlSet : SqlClause, IReadOnlyCollection<SqlAssign>
{
    ...
    /// </summary>
    public override SqlExpressionType ExpressionType => SqlExpressionType.Set;
    ...
    /// </summary>
    public int Count => _assignExpressions.Count;
    ...
    {
        ArgumentNullException.ThrowIfNull(assignExpression);
