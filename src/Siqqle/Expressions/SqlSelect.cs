...
public class SqlSelect : SqlStatement
{
    ...
    /// </exception>
    internal SqlSelect(IEnumerable<SqlValue> columns)
    {
    ...
    /// </summary>
    public SqlLimit Limit { get; internal set; }

    /// <summary>
    /// Gets the expression type of this expression.
    /// </summary>
    public override SqlExpressionType ExpressionType => SqlExpressionType.Select;
