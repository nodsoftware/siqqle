...
{
    internal class SqlSelectOrderByBuilder : ISqlSelectThenBySyntax, ISqlSelectLimitClause, IHasSqlStatementBuilder<SqlSelectBuilder, SqlSelect>
    {
        public SqlSelectOrderByBuilder(SqlSelectBuilder builder, SqlColumn column, SqlSortOrder sortOrder)
        {
            Builder = builder;
