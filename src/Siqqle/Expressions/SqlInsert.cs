...
public class SqlInsert : SqlStatement
{
    ...
    /// </summary>
    public SqlInto Into { get; internal set; }

    /// <summary>
    /// Gets the collection of columns into which this <see cref="SqlInsert" /> inserts rows.
    /// </summary>
    public IEnumerable<SqlColumn> Columns { get; internal set; }
    ...
    /// </summary>
    public override SqlExpressionType ExpressionType => SqlExpressionType.Insert;
